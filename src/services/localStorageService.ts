    ...
    const sampleProducts: Product[] = [
      {
        ...
        category: 'dairy',
        description: 'Thick and creamy curd, set naturally',
        vendorId: 'vendor1',
      ...
      },
      {
        ...
        price: 35,
        originalPrice: 50,
        image: 'https://images.unsplash.com/photo-1518977676601-b53f82ber680?w=300&h=300&fit=crop',
        category: 'vegetables',
        description: 'Premium quality fresh potatoes',
        vendorId: 'vendor1',
        vendorName: 'Fresh Groceries',
        vendorEmail: 'vendor@example.com',
        stock: 100,
      ...
      },
      {
        ...
        price: 45,
        originalPrice: 60,
        image: 'https://images.unsplash.com/photo-1542991306-364f68c836f2?w=300&h=300&fit=crop',
        category: 'vegetables',
        description: 'Farm-fresh, vine-ripened tomatoes perfect for salads and cooking',
        vendorId: 'vendor2',
        vendorName: 'Organic Foods',
        vendorEmail: 'vendor2@example.com',
        stock: 60,
      ...
      },
      {
        ...
        category: 'dairy',
        description: 'Soft and fresh paneer, great for curries',
        vendorId: 'vendor1',
        vendorName: 'Fresh Groceries',
        vendorEmail: 'vendor@example.com',
        stock: 25,
